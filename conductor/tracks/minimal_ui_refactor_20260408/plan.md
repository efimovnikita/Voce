...
- [x] Task: Add a small Icon Button (Gear icon) to the top corner of the application. [2ed075f]
- [x] Task: Connect the Icon Button to the Modal state (Open/Close). [2ed075f]
